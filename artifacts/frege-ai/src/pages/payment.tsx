...
const PLANS = [
  ...
  },
  {
    ...
    price: "₦59,000",
    period: "/3 months",
    description: "Save ₦1,000 vs monthly",
  ...
  },
  {
    ...
    price: "₦75,000",
    period: "/year",
    description: "Best value — save ₦165,000",
    features: ["Everything in 3 Months", "Save ₦165,000", "Free extension officer consult", "Priority scan credits"],
    popular: false,
    color: "border-[#1E3A8A]",
    badge: "Best Value",
  },
